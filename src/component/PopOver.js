...
const sgBData = [
  {
    ...
    background : "#FFD4E5",
    url: "http://www.ikmr.co.kr/sub/sub3_3.asp"
  },
  {
    title:"경영혁신",
    context : ["#건강한 조직문화", "#4대 보험", "#고용유지율 높음", "#임금체불 X"],
    background : "#85D6A3",
    url: "https://www.mainbiz.go.kr/usr/mainbizInfo/descriptMainbiz.do"
  },
  {
    title:"기술혁신",
    context : ["#연봉 만족도 높음", "#기술 경쟁력", "#낮은 부채비율", "#R&D 투자"],
    background : "#7afffa",
    url: "https://www.innobiz.net/intro/intro1.asp"
  },
  {
    title:"청년친화",
    context : ["#우수한 근무환경", "#건강한 조직문화", "#고용안정성", "#높은 신용평가","#워라벨"],
    background : "#6495ed",
    url: "https://www.work.go.kr/jobyoung/smallGiants/smallGiantsMain.do"
  },
  {
    title:"강소기업",
    context : ["#준수한 신용평가", "#고용 유지율 높음", "#임금체불 X", "#4대 보험","#경조사비"],
    background : "#FFE599",
    url: "https://www.work.go.kr/jobyoung/smallGiants/smallGiantsBasicMain.do#tmp"
  },
]
const styles = theme => ({
  container: {
          ...
          {(popupState) => (
            <div>
              ...
              >
                ...
                <Link href={target.url} target="_blank">자세히 보기</Link>
                </Box>
              </Popover>
            </div>
          )}
